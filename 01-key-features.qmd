...
When the output is added to Map View it provides clear picture of where the two soil maps disagree about the amount of soil organic carbon and by how much.
